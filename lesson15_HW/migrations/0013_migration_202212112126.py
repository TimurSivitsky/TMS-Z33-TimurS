...
class User_session(peewee.Model):
    ...
    last_login_dt = DateTimeField(default='2022-12-11 21:26:18.801700')
...
def backward(old_orm, new_orm):
    ...
    return [
        # Apply default value datetime.datetime(2022, 12, 11, 21, 26, 18, 809700) to the field tickets.status_change_dt,
        tickets.update({tickets.status_change_dt: datetime.datetime(2022, 12, 11, 21, 26, 18, 809700)}).where(tickets.status_change_dt.is_null(True)),
    ]
